  ...
  return (
    <div className="wf-login">
      <div className="wf-login-card">
        ...
        <div className="wf-login-sub">Créer un compte Facturation</div>

        {error && <div className="wf-error">{error}</div>}

        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            { label: 'Nom complet',  val: name,     set: setName,     type: 'text',     ph: 'Sophie Martin',             req: true  },
            { label: 'Email',        val: email,    set: setEmail,    type: 'email',    ph: 'sophie@transvirex.fr',      req: true  },
