  ...
  return (
    <div className="wf-login">
      <div className="wf-login-card">
        ...
        <div className="wf-login-sub">Créer un compte Dispatcher</div>

        {error && <div className="wf-error">{error}</div>}

        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            { label: 'Nom complet',    val: name,     set: setName,     type: 'text',     ph: 'Léa Robert', req: true },
            { label: 'Email',          val: email,    set: setEmail,    type: 'email',    ph: 'lea@transvirex.fr', req: true },
