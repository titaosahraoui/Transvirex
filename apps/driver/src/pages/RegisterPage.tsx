  ...
  return (
    <div className="wf-login">
      <div className="wf-login-card">
        ...
        <div className="wf-login-sub">Créer un compte Chauffeur</div>

        {error && <div className="wf-error">{error}</div>}

        <form onSubmit={handleSubmit} style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
          {[
            { label: 'Nom complet',  val: name,     set: setName,     type: 'text',     ph: 'Karim Benali',      req: true  },
            { label: 'Email',        val: email,    set: setEmail,    type: 'email',    ph: 'karim@transvirex.fr', req: true },
            { label: 'Téléphone',    val: phone,    set: setPhone,    type: 'tel',      ph: '+33 6 12 …',        req: false },
